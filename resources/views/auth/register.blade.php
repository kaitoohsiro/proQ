            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="login-form" method="POST" action="{{ route('register') }}">
                        ...
                        <input type="text" class="login-username @error('name') is-invalid @enderror" autofocus="true" required="true" placeholder="name(表示名)" name="name" value="{{ old('name') }}" autocomplete="name" autofocus />
                        @error('name')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                        @enderror
                        <input type="email" class="login-username @error('email') is-invalid @enderror" autofocus="true" required="true" placeholder="Email" name="email" value="{{ old('email') }}" autocomplete="email" />
                        @error('email')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
